...
//	IMobileCocos2dxModule::setVisibility(adViewId_mid, false);
	...
	// フルスクリーンインステ
	IMobileCocos2dxModule::registerSpotFullScreen(IMOBILE_FULLSCREENAD_PID,IMOBILE_FULLSCREENAD_MID, IMOBILE_FULLSCREENAD_SID);

	instFlg = true;
	// テキストポップアップ
	IMobileCocos2dxModule::registerSpotFullScreen(IMOBILE_TEXTPOPUP_PID,IMOBILE_TEXTPOPUP_MID, IMOBILE_TEXTPOPUP_SID);
	txtFlg = true;
